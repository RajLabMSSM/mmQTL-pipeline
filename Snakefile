...
rule fullCollate:
    ...
    shell:
        ...
        for i in $chr; do 
            ...
            sort --parallel=8 -k3,3V -k4,4n {params.prefix}/${{i}}_full_assoc_peak_{wildcards.PEAK}.tsv > {params.prefix}/${{i}}_full_assoc_peak_{wildcards.PEAK}.sorted.tsv
        done
        ...
        cat {params.prefix}/chr*_full_assoc_peak_{wildcards.PEAK}.sorted.tsv | sort --parallel=8 -k3,3V -k4,4n >> {params.tsv}
